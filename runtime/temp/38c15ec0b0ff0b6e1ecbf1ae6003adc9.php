<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/var/www/html/thinkphp/public/../application/admin/view/admin/lst.htm";i:1533520304;s:60:"/var/www/html/thinkphp/application/admin/view/common/top.htm";i:1533520771;s:61:"/var/www/html/thinkphp/application/admin/view/common/left.htm";i:1533452395;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="50%">用户名称</th>
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>　<!-- //循环模板变量list  -->
                ...
                <tr>
                                ...
                                <td align="center">
                                    ...
                                    <?php if($vo['id']!=1): ?>
                                    <a href="<?php echo url('admin/del',array('id'=>$vo['id'])); ?>" onClick="return confirm('确认删除吗?')" class="btn btn-danger btn-sm shiny">
