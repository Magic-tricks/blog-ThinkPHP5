<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/var/www/html/thinkphp/public/../application/index/view/article/article.html";i:1533520304;s:64:"/var/www/html/thinkphp/application/index/view/common/header.html";i:1533454229;s:63:"/var/www/html/thinkphp/application/index/view/common/right.html";i:1533437647;s:62:"/var/www/html/thinkphp/application/index/view/common/foot.html";i:1532442854;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script type='text/javascript' src='http://localhost/thinkphp/public/static/index/style/ismobile.js'></script>
    </head>
...
<div class="hotmenu">
    <div class="con">热门标签：
        ...
        <div class="position"><a href="<?php echo url('index/index'); ?>">主页</a> > <a href="<?php echo url('cate/cate',array('cateid'=>$cates['id'])); ?>"><?php echo $cates['catename']; ?></a> >  </div>
 ...
 ?></span>
                        <span class="writor">热度：<?php echo $articles['click']; ?><script src="/jiehun/plus/count.php?view=yes&aid=156214&mid=55" type='text/javascript' language="javascript"></script></span>
                    </div>
                </div>
                ...
                <div class="xgread">
                    ...
                    <div class="rig">
                        <ul>
                            ...
                            <li><a href="<?php echo url('article/article',array('arid'=>$vo['0'])); ?>" target="_blank"><?php echo $vo['1']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="hotsnew">
                    ...
                    <ul>
                        ...
                        <li><div class="tu"><a href='http://localhost/thinkphp/public/static/index/images/20160920156214.html' target="_blank"><img src="<?php if($vo['pic']==''): ?>http://localhost/thinkphp/public/static/index/images/error.png <?php else: ?> http://localhost/thinkphp/public<?php echo $vo['pic']; endif; ?>" alt="广州公司聚餐好去处 聚餐"/></a></div><p><a href='http://localhost/thinkphp/public/static/index/images/20160920156214.html'><?php echo $vo['title']; ?></a></p></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>		
            </div>
